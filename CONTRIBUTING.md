Contributing to Ohmcoin Core
============================

The Ohmcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ohmcoin Core project, and is not to be
confused with overall Ohmcoin Network Protocol consensus changes.

Whether a pull request is merged into Ohmcoin Core rests with the project merge
...
Patches that change Ohmcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ohmcoin consensus, it must have been
...
The project leader is the release manager for each Ohmcoin Core release.
