Contributing to OHMC Core
============================

The OHMC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OHMC Core project, and is not to be
confused with overall OHMC Network Protocol consensus changes.

Whether a pull request is merged into OHMC Core rests with the project merge
...
Patches that change OHMC consensus rules are considerably more involved than
...
Where a patch set proposes to change the OHMC consensus, it must have been
...
The project leader is the release manager for each OHMC Core release.
