...
RESOURCES += src/qt/ohmc.qrc src/qt/ohmc_locale.qrc

TRANSLATIONS += src/qt/locale/ohmc_bg.ts \
                src/qt/locale/ohmc_de.ts \
                src/qt/locale/ohmc_en.ts \
                src/qt/locale/ohmc_es.ts \
                src/qt/locale/ohmc_fi.ts \
                src/qt/locale/ohmc_fr.ts \
                src/qt/locale/ohmc_it.ts \
                src/qt/locale/ohmc_ja.ts \
                src/qt/locale/ohmc_pl.ts \
                src/qt/locale/ohmc_pt.ts \
                src/qt/locale/ohmc_ru.ts \
                src/qt/locale/ohmc_sk.ts \
                src/qt/locale/ohmc_sv.ts \
                src/qt/locale/ohmc_vi.ts \
                src/qt/locale/ohmc_zh_CN.ts \
                src/qt/locale/ohmc_zh_TW.ts
