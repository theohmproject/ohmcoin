...
#   c) node1 mines 32 blocks, so now node 0 has 60001ohmc, node 1 has 4250ohmc, node2 has none.
#   d) node0 sends 601 ohmc to node2, in two transactions (301 ohmc, then 300 ohmc).
