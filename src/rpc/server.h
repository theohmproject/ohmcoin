...
extern UniValue obfuscation(const UniValue& params, bool fHelp); // in rpc/karmanode.cpp
...
extern UniValue knbudget(const UniValue& params, bool fHelp); // in rpc/karmanode-budget.cpp
