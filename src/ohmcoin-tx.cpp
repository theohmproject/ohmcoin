...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ohmcoin Core ohmcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ohmcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ohmcoin transaction") + "\n" +
                               "  ohmcoin-tx [options] -create [commands]   " + _("Create hex-encoded ohmcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ohmcoin transaction
