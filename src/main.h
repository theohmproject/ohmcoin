...
static const unsigned int MAX_STANDARD_TX_COST = 100000;
...
extern bool fIgnoreLegacyBlocks;
...
int64_t GetKarmanodePayment(int nHeight, int64_t blockValue, int nKarmanodeCount = 0);
