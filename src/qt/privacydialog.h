...
public:
    ...
    void setZOhmcControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzOHMC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzOHMC_clicked();
    void on_pushButtonZOhmcControl_clicked();
    void on_pasteButton_clicked();
    void updateDisplayUnit();
    void updateSPORK18Status();
};
