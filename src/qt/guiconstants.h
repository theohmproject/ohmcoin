...
/* Ohmcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Ohmcoin"
#define QAPP_ORG_DOMAIN "ohmcoin.org"
#define QAPP_APP_NAME_DEFAULT "Ohmcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Ohmcoin-Qt-testnet"
