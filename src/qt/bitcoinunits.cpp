...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(OHMC);
    unitlist.append(mOHMC);
    unitlist.append(uOHMC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case OHMC:
        return QString("ohmcoin");
    case mOHMC:
        return QString("mohmcoin");
    case uOHMC:
        return QString::fromUtf8("uohmcoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case OHMC:
            return QString("OHMC");
        case mOHMC:
            return QString("mOHMC");
        case uOHMC:
            return QString::fromUtf8("μOHMC");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case OHMC:
            return QString("tOHMC");
        case mOHMC:
            return QString("mtOHMC");
        case uOHMC:
            return QString::fromUtf8("μtOHMC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case OHMC:
            return QString("OHMC");
        case mOHMC:
            return QString("Milli-OHMC (1 / 1" THIN_SP_UTF8 "000)");
        case uOHMC:
            return QString("Micro-OHMC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case OHMC:
            return QString("TestOHMCs");
        case mOHMC:
            return QString("Milli-TestOHMC (1 / 1" THIN_SP_UTF8 "000)");
        case uOHMC:
            return QString("Micro-TestOHMC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
