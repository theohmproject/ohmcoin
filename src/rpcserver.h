...
extern json_spirit::Value privatesend(const json_spirit::Array& params, bool fHelp); // in rpckarmanode.cpp
extern json_spirit::Value getpoolinfo(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value karmanode(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value listkarmanodes(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getkarmanodecount(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value karmanodeconnect(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value karmanodecurrent(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value karmanodedebug(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value startkarmanode(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value createkarmanodekey(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getkarmanodeoutputs(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value listkarmanodeconf(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getkarmanodestatus(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getkarmanodewinners(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getkarmanodescores(const json_spirit::Array& params, bool fHelp);

extern json_spirit::Value mnbudget(const json_spirit::Array& params, bool fHelp); // in rpckarmanode-budget.cpp
