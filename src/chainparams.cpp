...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1531692959, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 52020;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // OHMC starting difficulty is 1 / 2^12
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // OHMC: 1 day
        nTargetSpacing = 1 * 60;  // OHMC: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet ohmc BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ohmc BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ohmc BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Ohm: 1 day
        nTargetSpacing = 1 * 60;        // Ohm: 1 minutes
