...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_18_MN_WINNER_MINIMUM_AGE) r = SPORK_18_MN_WINNER_MINIMUM_AGE_DEFAULT;
        if (nSporkID == SPORK_19_SEGWIT_ACTIVATION) r = SPORK_19_SEGWIT_ACTIVATION_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_18_MN_WINNER_MINIMUM_AGE") return SPORK_18_MN_WINNER_MINIMUM_AGE;
    if (strName == "SPORK_19_SEGWIT_ACTIVATION") return SPORK_19_SEGWIT_ACTIVATION;
    if (strName == "SPORK_20_ZEROCOIN_MAINTENANCE_MODE") return SPORK_19_SEGWIT_ACTIVATION;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_18_MN_WINNER_MINIMUM_AGE) return "SPORK_18_MN_WINNER_MINIMUM_AGE";
    if (id == SPORK_19_SEGWIT_ACTIVATION) return "SPORK_19_SEGWIT_ACTIVATION";
