...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_22_SEGWIT_ON_COINBASE) r = SPORK_22_SEGWIT_ON_COINBASE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_22_SEGWIT_ON_COINBASE") return SPORK_22_SEGWIT_ON_COINBASE_DEFAULT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_22_SEGWIT_ON_COINBASE) return "SPORK_22_SEGWIT_ON_COINBASE";
