...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ohmc features */
        {"ohmc", "karmanode", &karmanode, true, true, false},
        {"ohmc", "listkarmanodes", &listkarmanodes, true, true, false},
        {"ohmc", "getkarmanodecount", &getkarmanodecount, true, true, false},
        {"ohmc", "karmanodeconnect", &karmanodeconnect, true, true, false},
        {"ohmc", "karmanodecurrent", &karmanodecurrent, true, true, false},
        {"ohmc", "karmanodedebug", &karmanodedebug, true, true, false},
        {"ohmc", "startkarmanode", &startkarmanode, true, true, false},
        {"ohmc", "createkarmanodekey", &createkarmanodekey, true, true, false},
        {"ohmc", "getkarmanodeoutputs", &getkarmanodeoutputs, true, true, false},
        {"ohmc", "listkarmanodeconf", &listkarmanodeconf, true, true, false},
        {"ohmc", "getkarmanodestatus", &getkarmanodestatus, true, true, false},
        {"ohmc", "getkarmanodewinners", &getkarmanodewinners, true, true, false},
        {"ohmc", "getkarmanodescores", &getkarmanodescores, true, true, false},
        {"ohmc", "mnbudget", &mnbudget, true, true, false},
        {"ohmc", "preparebudget", &preparebudget, true, true, false},
        {"ohmc", "submitbudget", &submitbudget, true, true, false},
        {"ohmc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ohmc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ohmc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ohmc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ohmc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ohmc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ohmc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ohmc", "checkbudgets", &checkbudgets, true, true, false},
        {"ohmc", "mnsync", &mnsync, true, true, false},
        {"ohmc", "spork", &spork, true, true, false},
        {"ohmc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ohmc", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ohmcd, or the -server option to ohmc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ohmc-cli " + methodname + " " + args + "\n";
}
