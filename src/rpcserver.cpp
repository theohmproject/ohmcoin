...
static const CRPCCommand vRPCCommands[] =
        ...
        {"generating", "setgenerate", &setgenerate, true, true, false},
                ...
                {"ohmcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
                {"ohmcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
                {"ohmcoin", "checkbudgets", &checkbudgets, true, true, false},
                {"ohmcoin", "mnsync", &mnsync, true, true, false},
