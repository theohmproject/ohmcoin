/* src/config/ohmc-config.h.  Generated from ohmc-config.h.in by configure.  */
/* src/config/ohmc-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef OHMC_CONFIG_H

#define OHMC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.ohmc.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ohm Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ohm Core 2.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ohmc"
