...
#define MASTER_NODE_AMOUNT 3000
...
/**
 * The alert message broadcasts various alerts to users of the Ohmcoin, but has
...
/**
 * MNW syncs karmanode winners between peers. These are karmanodes that
 * win the block reward for a specifed block.
 */
extern const char *MNW;
/**
 * MPROP syncs karmanode proposals between peers. Karmanode proposals can
 * be used to submit budget proposals or sync them between peers.
 */
extern const char *MPROP;
/**
 * MVOTE votes for a karmanode proposal and syncs karmanode votes between
 * peers. Karmanode votes are used to choose which budget proposals win.
 */
...
/**
 * DSTX allows for prioritised free transactions for karmanodes.
 */
