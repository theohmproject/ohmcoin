...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ohm Core ohmc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ohmc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ohmc transaction") + "\n" +
                               "  ohmc-tx [options] -create [commands]   " + _("Create hex-encoded ohmc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ohmc transaction
