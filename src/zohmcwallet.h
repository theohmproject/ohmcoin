...
#ifndef OHMCOIN_ZOHMCWALLET_H
#define OHMCOIN_ZOHMCWALLET_H
...
public:
    CzOHMCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZOHMC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZOHMC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //OHMCOIN_ZOHMCWALLET_H
