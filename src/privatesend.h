...
public:
    ...
    void UpdateState(unsigned int newState)
    {
        if (fMasterNode && (newState == POOL_STATUS_ERROR || newState == POOL_STATUS_SUCCESS)) {
            LogPrint("privatesend", "CPrivateSendPool::UpdateState() - Can't set state to ERROR or SUCCESS as a Karmanode. \n");
            return;
        }
    ...
    /// Get Karmanode updates about the progress of PrivateSend
    ...
    /// Get the denominations for a specific amount of ohmc.
