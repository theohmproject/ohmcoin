...
In order to support loading of multiple wallets in ohmcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ohmcoin.cpp.
...
Changes to ohmcoin.cpp
----------------------
ohmcoin.cpp is the entry point into ohmcoin-qt, and as such, will require some minor modifications to provide hooks for
