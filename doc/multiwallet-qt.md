...
In order to support loading of multiple wallets in ohmc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ohmc.cpp.
...
Changes to ohmc.cpp
----------------------
ohmc.cpp is the entry point into ohmc-qt, and as such, will require some minor modifications to provide hooks for
