...
2. autocombinerewards feature - Automatically combines karmanode reward once spendable into a single input.
...
6. Multisend now can filter between staking and karmanode rewards (soon). Also some bugs addressed.
...
10. Added Fallback Seed Nodes - You no longer need to add initial addnodes lines to ohmc.conf!
