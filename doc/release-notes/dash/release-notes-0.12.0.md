...
- Implemented new decentralized karmanode payment consensus system
- Improved speed of DS
- New karmanode payment/winners/budgets syncing strategy
- Platform independent karmanode ranking system
- Karmanode broadcasts, pings and winners now use the inventory system
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/ohmcoin-project/ohmcoin-project-translations).
