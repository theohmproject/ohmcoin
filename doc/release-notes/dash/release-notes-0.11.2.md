...
Karmanode enhancements
-----------------------

When restarting the client the karmanodes will be stored in the datadir in
...
- Karmanode caching
- Karmanode payment scheduler
- Better protection from cheating karmanodes
- Extended functionality for `karmanode list` RPC command
